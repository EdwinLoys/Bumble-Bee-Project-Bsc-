<?php
 ...
 <?php if (isset($_GET['view'])):
 	...
 	$imgPath= "../images/Product_Images/";
 				...
 				$product_dt= "SELECT * FROM trouser_tbl WHERE trouser_id=".$pid;
...
<?php
	...
	$sql= "SELECT * FROM trouser_details WHERE TID=".$pid." AND  Size='".$size."'";
		...
		<div class="carousal-tab">
			<div class="move-carousal">
				<div class="owl-carousel owl-theme">
					...
					$related_products="SELECT * FROM trouser_details INNER JOIN trouser_tbl ON trouser_details.TID = trouser_tbl.trouser_id WHERE  TrouserType='$ptype' LIMIT 10";
            ...
            <center>
						 <a class="product_link" href="Trousers_details.php?view&productid='.$get['TID']."&size=".$get['Size'].'" class="title">
               '.ucfirst($get['TrouserName']).' </a>
               </center>
               </div>';
					}
					 ?>
