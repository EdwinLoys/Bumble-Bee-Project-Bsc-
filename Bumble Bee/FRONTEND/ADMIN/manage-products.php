...
<html lang="en" dir="ltr">
    ...
    <title>Manage Shirts Details | Admin</title>
<head>
...
<?php if (isset($_SESSION['admin_'])) {
  ...
  <div class="container">
    <div class="row">
      <div class="col"><h1>CircleM Admin | Manage Shirts Details</h1>
          ...
          <div class="card-body">
            <div class="tab-content" id="myTabContent">
              ...
              <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                ...
                <form  class="" method="post" action="../../PHP/ADMIN/admin.add-products.php" enctype="multipart/form-data" id="Addproduct-form">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <input type="text" name="productName" placeholder="Product name..." class="form-control form-control-alternative" id="exampleFormControlInput1">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <textarea name="productDesc" placeholder="Product Description..." class="form-control form-control-alternative" id="exampleFormControlInput1"></textarea>
...
<div class="col">
  <div class="col-md-6">
    <?php
    $num_of_products="SELECT * FROM shirts_tbl";
    ...
    <table class="table align-items-center table-dark" style="position:relative;">
      <thead class="thead-dark" >
        <tr style="position:sticky;">
          ...
          <th scope="col">Product Flavour</th>
      ...
      <tbody>
        ...
        $products= "SELECT * FROM shirts_tbl";
          ...
          <tr>
            <td scope="row">
              <div class="media-body">
                ...
                echo '<span class="mb-0 text-sm">'.$row['ProductName'].'</span>';
                echo "<input type=hidden name=pname_ value='".$row['ProductName']."'>";
                echo "<input type=hidden name=pid_ value='".$row['Product_id']."'>";
            ...
            <td>
              ...
              if ($product_type_row= mysqli_fetch_array($product_tp_rec)) {
                echo '<span class="mb-0 text-sm">'.$product_type_row['ProductType'].'</span>';
                echo "<input type=hidden name=ptype_ value='".$product_type_row['ProductType']."'>";
            ...
            <td>
              <div class="d-flex align-items-center">
                <?php
                echo "<table>";
                  $product_details= "SELECT * FROM shirt_details WHERE PID=".$row['Product_id'].";";
                ...
                <td class="text-right">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                      <?php
                      echo '<a class="dropdown-item" name="edit_products" href="edit-products.php?action=edit&productid='.$row['Product_id'].'&size='.$product_details_row['Size'].'">Edit</a>';
                      echo '<a class="dropdown-item" name="delete_products" href="edit-products.php?action=delete&productid='.$row['Product_id'].'&size='.$product_details_row['Size'].'">Delete</a>';
      ...
      <div class="tab-pane fade" id="tabs-icons-text-3" role="tabpanel" aria-labelledby="tabs-icons-text-3-tab">
        <form class="" action="../../PHP/ADMIN/admin.add-ptypes.php" method="post">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
