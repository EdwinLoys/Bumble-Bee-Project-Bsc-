    ...
    <div class="full">
    		...
    		<div class="filter-bar">
    				<div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
    					<h1>Filter by: </h1>
                  <button class="accordion">Trouser Brands</button>
                    <div class="panel">
              ...
              <button class="accordion">Trouser Type</button>
                <div class="panel">

    						<?php

    						$query = "
    						SELECT * FROM trouser_type
    						";
    						$statement = mysqli_query($conn,$query);
    						...
    						<label><input type="checkbox" class="common_selector type" value="<?php echo $row['PTID']; ?>" > <?php echo $row['TrouserType']; ?></label>
    					</div>
    					<?php
    				}
